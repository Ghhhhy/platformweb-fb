...
// 本地调试
//// 在Bs-vxe-table修改完后，执行npm run push  
////在业务项目中引入, 本地引入路径根据自己项目物理路径修改成自己的
import VXETable from '/Users/mac/workspace/company/boss/czb/czbxm/czb/czb-fiscal-front/.yalc/@bszx/bs-vxe-table/packages/vxe-table.js'

// 发包
npm run lib
npm publish
npm unpublist --force //同版本撤销
```
