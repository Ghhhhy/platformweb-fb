      ...
      h('div', {
        ...
        h('div', {
          ...
          h('div', {
            ...
            domProps: !defaultSlot && typeof (content) === 'function' ? {
              innerHTML: content(h, { $modal: this })
            } : {}
          }, defaultSlot ? (!inited || (destroyOnClose && !visible) ? [] : defaultSlot.call(this, { $modal: this }, h)) : (typeof (content) === 'function' ? '' : UtilTools.getFuncText(content))),
          !isMsg ? h('div', {
            class: ['vxe-loading', {
              'is--visible': loading
            }]
