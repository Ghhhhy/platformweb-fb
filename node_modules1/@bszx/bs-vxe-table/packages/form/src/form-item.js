...
export default {
  ...
  props: {
    ...
    itemRender: Object,
    showTooltip: { type: Boolean, default: null },
  },
  inject: {
    $vxeform: {
      default: null
  ...
  render(h) {
    ...
    const params = { showTooltip: this.showTooltip, data: $vxeform.data, property: field, item: this, $form: $vxeform }
    if (visible === false) {
      return _e()
    }
    ...
    const onsc = showTooltip && $vxeform ? {
      mouseenter(evnt) {
        $vxeform.triggerHeaderHelpEvent(evnt, params, true)
      },
      mouseleave: $vxeform.handleTargetLeaveEvent
    } : {}
    return h('div', {
