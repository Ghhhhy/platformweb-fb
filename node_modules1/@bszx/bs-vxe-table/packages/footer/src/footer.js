...
export default {
  ...
  render (h) {
    let { _e, $parent: $xetable, fixedType, fixedColumn, tableColumn, footerTableData, footerData } = this
    const {
    ...
    let renderType = footerData && footerData.length ? 'dataObj' : 'data'
    let renderData = (footerData && footerData.length ? footerData : footerTableData) || []
    // 如果是使用优化模式
      ...
      h('table', {
        ...
        h('tfoot', {
          ...
          return h('tr', {
            ...
            const params = { $table: $xetable, _rowIndex, $rowIndex, column, columnIndex, $columnIndex, _columnIndex, itemIndex, items: list, fixed: fixedType, type: cellType, data: footerTableData, renderType }
            // 虚拟滚动不支持动态高度
