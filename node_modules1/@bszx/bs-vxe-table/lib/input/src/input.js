...
var _default2 = {
  ...
  methods: {
    ...
    triggerEvent: function triggerEvent(evnt) {
      // const { isDatePicker,$refs, value, inputValue} = this
      var $refs = this.$refs,
          inputValue = this.inputValue; // this.$emit(evnt.type, { $panel: $refs.panel, value: isDatePicker ? value : inputValue, $event: evnt }, evnt)
    ...
    emitUpdate: function emitUpdate(value, evnt) {
      ...
      this.$emit('input', value); // const { isDatePicker } = this
      // if (!isDatePicker) {
    ...
    inputEvent: function inputEvent(evnt) {
      ...
      var value = evnt.target.value; // if (!isDatePicker) {
    ...
    numberMousedownEvent: function numberMousedownEvent(evnt) {
      ...
      if (evnt.button === 0) {
        ...
        this.downbumTimeout = setTimeout(function () {
          if (isPrevNumber) {
            _this5.numberDownPrevEvent(evnt);
          } else {
            _this5.numberDownNextEvent(evnt);
          }
        }, 500);
      }
    },
    ...
    dateOpenPanel: function dateOpenPanel() {
      ...
      if (this.hasTime) {
        ...
        this.$nextTick(function () {
          _ctor.default.arrayEach(_this6.$refs.timeBody.querySelectorAll('li.is--selected'), _this6.updateTimePos);
        });
      }
    },
    ...
    updatePlacement: function updatePlacement() {
      ...
      return this.$nextTick().then(function () {
        var $refs = _this9.$refs,
            transfer = _this9.transfer,
            placement = _this9.placement,
            panelIndex = _this9.panelIndex;
        ...
        if (targetElem && panelElem) {
          ...
          _this9.panelStyle = panelStyle;
          _this9.panelPlacement = panelPlacement;
