...
var _default = {
  ...
  render: function render(h) {
    ...
    var renderType = footerData && footerData.length ? 'dataObj' : 'data';
    var renderData = (footerData && footerData.length ? footerData : footerTableData) || []; // 如果是使用优化模式
    ...
    h('tfoot', {
      ref: 'tfoot'
    }, renderData.map(function (list, _rowIndex) {
