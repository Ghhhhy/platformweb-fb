...
var _default2 = {
  ...
  computed: {
    ...
    // isChecked() {
    //   return XEUtils.isBoolean(this.onValue) ? this.valueIn == this.openValue : this.valueIn == this.onValue
    // },
  ...
  methods: {
    ...
    clickEvent: function clickEvent(evnt) {
      ...
      if (!this.disabled) {
        ...
        this.valueIn = value;
        this.isChecked = _ctor.default.isBoolean(this.onValue) ? this.valueIn == this.openValue : this.valueIn == this.onValue;
        this.hasAnimat = true;
