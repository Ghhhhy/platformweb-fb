...
var _default = {
  methods: {
    ...
    handleActived: function handleActived(params, evnt) {
      ...
      var actived = editStore.actived; // if (this.currentActiveData) {
      //   this.emitEvent('edit-closed', this.currentActiveData)
      // }
      ...
      if (_tools.UtilTools.isEnableConf(editRender) && cell) {
        if (actived.row !== row || (mode === 'cell' ? actived.column !== column : false)) {
          ...
          var prevEditData = this.currentActiveData;
          this.currentActiveData = Object.assign({}, params, {
            row: row,
            prevEditData: prevEditData,
          ...
          this.emitEvent(type, this.currentActiveData, evnt);
        } else {
