...
const buttons = [
  { code: 'toolbar-insert', label: '新增', actionType: '1', glType: '3', actionName: '新增' },
  { code: 'toolbar-modify', label: '修改', actionType: '0', glType: '0', actionName: '修改' },
  { code: 'toolbar-delete', label: '删除', actionType: '5', glType: '5', actionName: '删除' },
  { code: 'toolbar-audit', label: '送审', actionType: '2', glType: '0', actionName: '送审' },
