...
export default {
  ...
  queryTableDatas(params) {
    return post('large-monitor-platform/lmp/warn/rpt/queryClassRptByMof', params)
  },
  queryTableDatas2(params) {
    return post('large-monitor-platform/lmp/warn/rpt/queryClassRpt2ByMof', params)
  },
  // 获取违规明细
