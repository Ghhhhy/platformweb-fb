...
export default {
  ...
  getSummaryTableData(params) {
    return post('dfr-service/v1/payreportdata/data', params)
  },
  isArea() {
    return get('pay-report-service/v1/payreportdata/isArea')
  },
  summaryData(tableId, fieldSize) {
    return get('pay-report-service/v1/payreportdata/summary/' + tableId + '/' + fieldSize)
  },
