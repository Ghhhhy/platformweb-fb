<template>
  <div class="card-content" :style="{ '--btn-btnColor': cardMenuIn.btnColor, '--btn-iconColor': cardMenuIn.iconColor }">
    <!-- <img :src="cardMenuIn.bgUrl" class="content-bg"> -->
    <div class="card-title">
      <i
        class="fn-inline base-font custom-title-icon"
    ...
    <div class="card-btns">
      ...
      >
        ...
        <span v-if="item.num && item.num !== 0 ? true : false" class="btn-num">{{ item.num }}条</span>
      </el-button>
    </div>
  </div>
</template>
...
<style  lang="scss" scoped>
  .card-content{
    // width: 356px;
    // height: 224px;
    background: linear-gradient(var(--btn-btnColor), #fff);
