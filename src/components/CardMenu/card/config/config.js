const defaultCardConfig = {
  btnColor: 'var(--hightlight-color)', // 按钮背景色
...
const defaultCardData = {
  ...
  buttons: [
    {
      icon: 'ri-apps-fill', // 按钮icon矢量图
      title: '功能菜单',
      code: 'funMenu' // 以这个为基准，cardBtns下的要对应 *  code值不要改
    },
    {
      icon: 'ri-play-circle-fill', // 按钮icon矢量图
      title: '操作指南',
      code: 'oprateGuide' // 以这个为基准，cardBtns下的要对应 * code值不要改
    },
    {
      icon: 'ri-calendar-todo-fill', // 按钮icon矢量图
      title: '待办事项',
      num: 0,
      code: 'agentItem' // 以这个为基准，cardBtns下的要对应 * code值不要改
    },
    {
      icon: 'ri-calendar-check-fill', // 按钮icon矢量图
      title: '已办事项',
      num: 0,
