// 命令 插件   Author: Titans@2396757591@qq.com
import utils from '../utils/utils.js'
const { mix, clone } = utils
class Command {
  constructor() {
    this.config = {}
  }
    ...
    if (this[name]) {
      ...
      const cmd = mix({}, {
        ...
        execute(graph) {
          ...
          this.method && (typeof (this.method) === 'string' ? graph[this.method]() : this.method(graph))
        },
        back(graph) {
  ...
  initCommands() {
    ...
    cmdPlugin.registerCommand('copy', {
      ...
      shortcutCodes: [['metaKey', 'c'], ['ctrlKey', 'c']]
    })
    ...
    cmdPlugin.registerCommand('beautify', { // 美化
      queue: false,
      enable: function (graph) {
