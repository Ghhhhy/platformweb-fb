    ...
    <template v-slot>
      <div class="option-line-group">
        <div class="fn-inline option-line-group-btn">
          <vxe-button size="mini" icon="ri-add-box-line" @click="insertRow">新增</vxe-button>
          <vxe-button size="mini" icon="ri-play-list-add-line" @click="insertFromTemplate">从模板新增</vxe-button>
          <vxe-button size="mini" icon="ri-delete-bin-line" @click="delRow">删除</vxe-button>
          <vxe-button size="mini" icon="ri-save-3-line" status="primary" @click="handleConfirm">保存</vxe-button>
        </div>
      </div>
      <BsTable
        ref="bsTableRef"
