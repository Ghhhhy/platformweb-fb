    ...
    <template v-slot>
      <div class="option-line-group">
        <div class="fn-inline option-line-group-btn">
          <vxe-button v-if="!isEmpty" round size="mini" icon="el-icon-scissors" @click="insert(true)">覆盖插入</vxe-button>
          <vxe-button v-if="!isEmpty" round size="mini" icon="el-icon-circle-plus-outline" @click="insert(false)">增量插入</vxe-button>
        </div>
      </div>
      <BsForm
        v-if="!isEmpty"
