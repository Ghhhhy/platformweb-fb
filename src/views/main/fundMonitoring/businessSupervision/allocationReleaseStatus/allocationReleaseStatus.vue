          ...
          <template v-slot:toolbarSlots>
            <div class="table-toolbar-left">
              <div class="table-toolbar-left-title">
                <span class="fn-inline">分配下达情况查询(单位:万元)</span>
                <i class="fn-inline"></i>
              </div>
            </div>
          </template>
...
<script>
import getFormData from './allocationReleaseStatus.js'
import DetailDialog from '../../capitalAccount/children/detailDialog.vue'
import SDetailDialog from '../../capitalAccount/children/sDetailDialog.vue'
