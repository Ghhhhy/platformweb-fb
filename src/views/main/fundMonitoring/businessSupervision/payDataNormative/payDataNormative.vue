...
export default {
  ...
  methods: {
    search(obj) {
      ...
      this.payAcctNoStr = obj.payAcctNoStr
      this.payeeAcctNameStr = obj.payeeAcctNameStr
      this.payeeAcctNoStr = obj.payeeAcctNoStr
      this.proNameStr = obj.proNameStr
      this.payTimeStr = obj.payTimeStr
    ...
    queryTableDatas() {
      const param = {
        ...
        userDesStr: this.userDesStr,
        payAcctNameStr: this.payAcctNameStr,
        payAcctNoStr: this.payAcctNoStr,
        payeeAcctNameStr: this.payeeAcctNameStr,
