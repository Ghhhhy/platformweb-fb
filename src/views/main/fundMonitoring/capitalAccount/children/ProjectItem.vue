  ...
  methods: {
    checkReport() {
      ...
      if (province?.slice(0, 4) === '3502') {
        ...
        const { mofDivCode = '' } = this.clickRowData
        url = `${originUrl}/ProjectRefineIframe?isShowHead=0&tokenid=${tokenid}&appguid=fiscal&proGuid=${this.proGuid}&mofDivCode=${mofDivCode}`
      }
