            ...
            children: [
              {
                ...
                width: 100,
                align: 'right',
                formula: $formula('budgetDisburseRegion.numberSnjZcjdZyap'),
                cellRender: {
                  name: '$vxeRatio'
                }
              },
              {
                ...
                width: 100,
                align: 'right',
                formula: $formula('budgetDisburseRegion.numberSnjZcjdSnjap'),
                cellRender: {
                  name: '$vxeRatio'
                }
              },
              {
                ...
                width: 100,
                align: 'right',
                formula: $formula('budgetDisburseRegion.numberSnjZcjdzje'),
                cellRender: {
                  name: '$vxeRatio'
                }
              }
            ...
            children: [
              {
                ...
                width: 100,
                align: 'right',
                formula: $formula('budgetDisburseRegion.numberSjZcjdZyap'),
                cellRender: {
                  name: '$vxeRatio'
                }
              },
              {
                ...
                width: 100,
                align: 'right',
                formula: $formula('budgetDisburseRegion.numberSjZcjdSnjap'),
                cellRender: {
                  name: '$vxeRatio'
                }
              },
              {
                ...
                width: 100,
                align: 'right',
                formula: $formula('budgetDisburseRegion.numberSjZcjdSjap'),
                cellRender: {
                  name: '$vxeRatio'
                }
              },
              {
                ...
                width: 100,
                align: 'right',
                formula: $formula('budgetDisburseRegion.numberSjZcjdZje'),
                cellRender: {
                  name: '$vxeRatio'
                }
              }
            ...
            children: [
              {
                ...
                width: 100,
                align: 'right',
                formula: $formula('budgetDisburseRegion.numberXjZcjdZyap'),
                cellRender: {
                  name: '$vxeRatio'
                }
              },
              {
                ...
                width: 100,
                align: 'right',
                formula: $formula('budgetDisburseRegion.numberXjZcjdSnjap'),
                cellRender: {
                  name: '$vxeRatio'
                }
              },
              {
                ...
                width: 100,
                align: 'right',
                formula: $formula('budgetDisburseRegion.numberXjZcjdSjap'),
                cellRender: {
                  name: '$vxeRatio'
                }
              },
              {
                ...
                width: 100,
                align: 'right',
                formula: $formula('budgetDisburseRegion.numberXjZcjdXjap'),
                cellRender: {
                  name: '$vxeRatio'
                }
              },
              {
                ...
                width: 100,
                align: 'right',
                formula: $formula('budgetDisburseRegion.numberXjZcjdZje'),
                cellRender: {
                  name: '$vxeRatio'
                }
              }
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  sortable: true,
                  cellRender: { name: '$vxeMoney' },
                  formula: '{amountZjpay}+{amountXjZcjeSnjap}+{amountXjZcjeSjap}+{amountXjZcjeXjap}+{amountZjZcjeZjap}'
                }
              ]
            },
            {
