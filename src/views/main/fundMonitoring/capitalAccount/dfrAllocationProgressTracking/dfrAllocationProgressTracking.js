    ...
    basicInfo: {
      ...
      tableColumnsConfig: [
        ...
        // },
        {
          ...
          align: 'right',
          type: 'amountZyxd',
          formula: '{amountSnjxd}+{amountSjxd}+{amountXjxd}+{amountZjxd}',
          sortable: true,
          cellRender: { name: '$vxeMoney' }
        },
        {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              align: 'right',
              sortable: true,
              formula: '({amountSnjxd}+{amountSnjxjfp}-0==0)?0:(({amountSnjbjfp}+{amountSnjxjfp})/({amountSnjxd})*100)',
              cellRender: {
                name: '$vxeRatio'
              }
            },
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              align: 'right',
              sortable: true,
              formula: '({amountXbjfp}+{amountXjwfp}+{amountXxjfp}-0==0)?0:(({amountXbjfp}+{amountXxjfp})/({amountXbjfp}+{amountXjwfp}+{amountXxjfp})*100)',
              cellRender: {
                name: '$vxeRatio'
              }
            },
            ...
            },
            {
              ...
              align: 'right',
              sortable: true,
              formula: '(({amountXbjfp}+{amountXxjfp})-0==0)?0:({amountXjpay}/({amountXbjfp}+{amountXxjfp})*100)',
              cellRender: {
                name: '$vxeRatio'
              }
            }
