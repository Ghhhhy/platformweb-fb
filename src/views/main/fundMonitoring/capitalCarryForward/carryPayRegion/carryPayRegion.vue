          ...
          <template v-slot:toolbarSlots>
            <div class="table-toolbar-left">
              <div class="table-toolbar-left-title">
                <span class="fn-inline">结转资金资金支出_分地区(单位:{{ moneyUnit }})</span>
                <i class="fn-inline"></i>
              </div>
            </div>
          </template>
  ...
  computed: {
    customExportConfig() {
      return {
        ...
        fileName: `结转资金资金支出_分地区(单位: ${this.tableGlobalConfig.customExportConfig.unit} )`
      }
    },
    moneyUnit() {
  ...
  data() {
    return {
      ...
      calculateConstraintConfig: {
        ...
        // colFormulaConfig: {
        //   all1: '{amountProvince}+{amountCity}+{amountCounty}',
        //   payAll: '{amountPayProvince}+{amountPayCity}+{amountPayCounty}',
        //   payPro: '(({payAll}/{all1})*100)',
        //   sjpayPro1: '(({amountPayProvince}-0=0)?0:({amountPayProvince}/{amountProvince}*100))',
        //   shijzcjd: '({amountPayCity}/{amountCity})*100',
        //   shijzcjdall: '({amountPayCity}/{amountCity})*100',
        //   xjzcjd: '({amountPayCounty}/{amountCounty})*100',
        //   xjzcjdzje: '({amountPayCounty}/{amountCounty})*100'
        // },
