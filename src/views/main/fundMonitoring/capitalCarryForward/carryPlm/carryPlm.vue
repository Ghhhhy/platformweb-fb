    ...
    <BsMainFormListLayout :left-visible.sync="leftTreeVisible">
      ...
      <template v-slot:mainForm>
        <BsTable
          ...
          :tree-config="{ dblExpandAll: true, dblExpand: true, iconClose: 'el-icon-circle-plus', iconOpen: 'el-icon-remove', lazy: true, hasChild: 'hasChild', loadMethod: loadChildrenMethod }"
          ...
          <template v-slot:toolbarSlots>
            <div class="table-toolbar-left">
              <div class="table-toolbar-left-title">
                <span class="fn-inline">直达机制项目全生命周期管理情况表(单位:万元)</span>
                <i class="fn-inline"></i>
              </div>
            </div>
          </template>
