            ...
            <template v-slot:toolbarSlots>
              <div class="table-toolbar-left">
                <div class="table-toolbar-left-title">
                  <span class="fn-inline">直达资金违规处理单结果审核</span>
                  <i class="fn-inline"></i>
                </div>
              </div>
            </template>
...
import { buttons1, curStatusButton, statusButtons } from './dfrViolationProcessingResultAudit'
...
export default {
  ...
  methods: {
    ...
    bsToolbarClickEvent(obj, $this) {
      ...
      this.params.status = this.tabSelect === '3' ? '4' : '5'
      this.refresh()
    },
