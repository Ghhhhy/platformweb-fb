          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-container>
                <el-main width="100%">
                  <el-row>
                    <div class="sub-title-add" style="width:100px;float:left;margin-top:8px"><font color="red">*</font>&nbsp;财政审核结果</div>
                    <el-select
          ...
          <el-row>
            <el-col :span="12">
              <el-container>
                <el-main width="100%">
                  <el-row>
                    <div class="sub-title-add" style="width:100px;float:left;margin-top:8px"><font color="red">*</font>&nbsp;财政审核意见</div>
                    <el-input
                      v-model="financeFlowOpinion1"
                      placeholder="请输入财政审核意见"
                      style="width:45%"
                    />
                  </el-row>
                </el-main>
...
export default {
  ...
  methods: {
    ...
    showInfo() {
      ...
      HttpModule.getDetail(params).then(res => {
        ...
        if (res.code === '000000') {
          ...
          this.financeFlowOpinion1 = res.data.financeFlowOpinion
        } else {
    ...
    // 审核
    doInsert() {
      console.log(this.financeFlowOpinion)
      if (this.financeFlowOpinion === '') {
        this.$message.warning('请选择财政审核结果')
        return
      }
      if (this.financeFlowOpinion1 === '' || this.financeFlowOpinion1 === null) {
        this.$message.warning('请输入财政审核意见')
        return
      }
      let declareCodes = []
      ...
      let param = {
        ...
        'flowOperation': 1,
        'flowOpinion': this.financeFlowOpinion1,
        menuId: this.$store.state.curNavModule.guid,
        menuName: this.$store.state.curNavModule.name
      }
      if (this.financeFlowOpinion === '审核通过') {
        this.addLoading = true
