...
export default {
  ...
  methods: {
    ...
    doInsert() {
      if (this.askAgencyTel === '') {
        this.$message.warning('请填写函询事项单位回复人电话')
        return
      }
      if (this.agencyOption === '') {
      ...
      const params = {
        ...
        askAgencyTel: this.askAgencyTel,
        agencyPerson: this.agencyPerson,
    ...
    showInfo() {
      ...
      this.agencyPerson = this.userInfo.name
    }
  },
  watch: {
  },
