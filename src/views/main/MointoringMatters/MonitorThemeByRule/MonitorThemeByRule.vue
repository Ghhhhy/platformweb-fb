...
import { proconf } from './MonitorThemeByRule'
import HttpModule from '@/api/frame/main/Monitoring/MonitorThemeByRule.js'
  ...
  methods: {
    ...
    cellClick(obj, context, e) {
      ...
      if (
        ...
        if (obj.row.fiRuleCode.length === 4) {
    ...
    generateColumn({ mofDivName, wholeNoHandleCount, wholeHandleCount, wholeCount, processingProgress }) {
      return {
        title: mofDivName,
        sortable: false,
        align: 'center',
