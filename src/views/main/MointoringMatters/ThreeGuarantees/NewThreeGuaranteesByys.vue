...
<script>
import { proconf } from './NewThreeGuaranteesByys'
...
export default {
  ...
  methods: {
    ...
    queryTableDatas1Count() {
      ...
      // }
      // HttpModule.queryTableDatas1Count(params).then(res => {
      //   if (res.rscode === '200') {
    ...
    queryTableDatas1() {
      ...
      HttpModule.queryTableDatas1(param).then(res => {
        ...
        if (res.code === '000000') {
          ...
          this.tableFooterConfig.totalObj.sbZxje = sbZxje
          this.tableFooterConfig.totalObj.sbZbje = sbZbje
