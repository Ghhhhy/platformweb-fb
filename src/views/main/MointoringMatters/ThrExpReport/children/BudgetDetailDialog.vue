...
export default {
  ...
  methods: {
    ...
    dialogClose() {
      this.$parent.budgetDetailVisible = false
    },
    ...
    queryTableDatas() {
      ...
      params.trackProName = this.condition.trackProName ? this.condition.trackProName[0] : ''
      ...
      HttpModule.budgetDetail(params).then((res) => {
        ...
        if (res.code === '000000') {
          ...
          this.tableFooterConfig.totalObj.amount = amount
        } else {
