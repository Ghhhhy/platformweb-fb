...
export default {
  ...
  methods: {
    ...
    buildFileType() {
      ...
      if (this.$gloableToolFn.getFilePreviewUrl().indexOf('10.100.59.197:7003') !== -1) {
        this.url = this.file.path.replace('http://10.100.58.16:7110', 'https://10.100.59.197:7003/preview')
      }
