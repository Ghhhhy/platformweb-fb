    ...
    toolbarConfig: { // table工具栏配置
      ...
      buttons: [
        ...
        },
        {
          ...
          name: '新增一行',
          callback: (obj, context, e) => {
            context.$parent.$parent.$parent.onTableAddRowClick(obj, context, e)
          }
        },
        {
          code: 'toolbar-insert',
          name: '新增弹框',
          callback: (obj, context, e) => {
            context.$parent.$parent.$parent.onTableAddModelClick(obj, context, e)
          }
        },
        {
          code: 'toolbar-xh',
          ...
          status: 'primary',
          callback: (obj, context, e) => {
            context.$parent.$parent.$parent.onyXhysClick(obj, context, e)
          }
        }, {
          name: '更多操作',
          disabled: false,
          dropdowns: [
            {
              ...
              name: '编辑弹框',
              callback: (obj, context, e) => {
                context.$parent.$parent.$parent.onTableEditModelClick(obj, context, e)
              }
            }]
        }]
    }
