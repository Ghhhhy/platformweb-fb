    ...
    tableColumnsConfig: [
      ...
      },
      {
        ...
        slots: {
          ...
          content(obj, h) {
            const { $table } = obj
            // let parent = $table.$parent.$parent.$parent.$parent.$parent.$parent
            // let hR = h(ExpandTable, {
            //   props: {
            ...
            // // return h('div',
            // //   {},
            // //   parent.CreatExpandVnode.expandTableVnode[rowIndex].$el
            // // )
            let $scopedSlots = $table.$parent.$parent.$scopedSlots
            if ($scopedSlots.expandContent) {
              let hR = $scopedSlots.expandContent(obj)
              return hR
            } else {
              return $scopedSlots.expandDefault && $scopedSlots.expandDefault
            }
          }
        }
        // <template slot="expand" slot-scope="slotData">
        //   <slot :data="slotData" name="expandContent"></slot>
        // </template>
        // <div slot-scope="scope">
        //   {{ scope }}
        //   <slot :data="scope" name="expandContent">
        //     <div class="f10">
        //       9
        //     </div>
        //   </slot>
