...
<script>
import SecondAndMinute from './children/secondAndMinute'
import hour from './children/hour'
import day from './children/day'
import month from './children/month'
import week from './children/week'
import year from './children/year'
export default {
  name: 'BsCron',
  props: { 
    value: {
